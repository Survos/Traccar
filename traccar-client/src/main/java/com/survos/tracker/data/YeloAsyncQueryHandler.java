...
import com.survos.tracker.data.DBInterface.AsyncDbQueryCallback;
...
class YeloAsyncQueryHandler {
    ...
    private class QueryAsyncTask extends
        ...
        protected QueryResult doInBackground(final QueryTask... params) {
            ...
            switch (task.mType) {
                case INSERT: {
                    result.mInsertRowId = YeloSQLiteOpenHelper
                ...
                case DELETE: {
                    result.mDeleteCount = YeloSQLiteOpenHelper
                                    .getInstance(TrackerApplication.getStaticContext())
                ...
                case UPDATE: {
                    result.mUpdateCount = YeloSQLiteOpenHelper
                                    .getInstance(TrackerApplication.getStaticContext())
                ...
                case QUERY: {
                    result.mCursor = YeloSQLiteOpenHelper
                                    .getInstance(TrackerApplication.getStaticContext())
